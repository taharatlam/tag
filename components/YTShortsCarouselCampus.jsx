...
import AlumniCampusCarousel from "./AlumniCampusCarousel/AluminiCampusCarousel";

const YTShortsCarouselCampus = () => {
...
export default YTShortsCarouselCampus;
