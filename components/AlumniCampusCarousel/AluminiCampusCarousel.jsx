...
function AlumniCampusCarousel({ data, type }) {
  ...
  let isSmaller = window.innerWidth <= 1440;
      ...
      <div className="position-relative d-flex flex-row align-items-center justify-content-center">
        ...
        <div className="d-flex flex-row align-items-center justify-content-center mx-3">
          <FadedElement
            ...
            style={{
              marginRight: -50,
              height: isSmaller ? "400px" : "500px",
              width: isSmaller ? "200px" : "300px",
              overflow: "hidden",
            }}
...
export default AlumniCampusCarousel;
